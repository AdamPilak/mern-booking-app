...
const SearchBar = () => {
    ...
    return <form onSubmit={handleSubmit} className="-mt-8 p-3 bg-orange-300 rounded shadow-md grid grid-cols-2 lg:grid-cols-3 2xl:grid-cols-5 items-center gap-4">
        ...
        <div className="flex gap-1">
            <button className="w-2/3 bg-blue-600 text-white h-full p-2 font-bold text-xl">Search</button>
            <button className="w-1/3 bg-red-600 text-white h-full p-2 font-bold text-xl">Clear</button>
        </div>
    </form>
}
